...
* **Azure IoT Hub Provisioning Client SDK:** TODO provisioning_client folder?
...
**Explore the C SDK through one of the walkthroughs.**

* Linux: [Device SDK on apt-get](https://github.com/Azure/azure-iot-sdk-c/blob/master/doc/ubuntu_apt-get_sample_setup.md)
...
# Samples
  ...
  Here are a set of samples that will help you get started:
